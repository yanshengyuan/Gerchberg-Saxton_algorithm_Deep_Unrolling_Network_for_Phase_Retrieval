...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = GSNet_Fresnel(intensity_near, args.layers)
    print(model)
...
def train(train_loader, model, criterion, optimizer, epoch, device, args):
    ...
    for i, (I, Phi) in enumerate(train_loader):
        ...
        # compute output
        Phi_pred = model(I)
        #plt.imsave('Phi.png', Phi_pred.squeeze().detach().cpu().numpy(), cmap='gray')
        #plt.imsave('I.png', I_pred.squeeze().detach().cpu().numpy(), cmap='gray')
