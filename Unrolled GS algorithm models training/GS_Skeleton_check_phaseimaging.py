...
from utils.loader_phaseimaging import  get_training_data,get_validation_data
from model_phaseimaging import GSNet_FFT, GSNet_Fresnel
...
def train(val_loader, train_loader, model, criterion, epoch, device, args):
    ...
    for i, (I, Phi, name) in enumerate(val_loader):
        ...
        np.save('pred_npy/' + name[0], outdata)
